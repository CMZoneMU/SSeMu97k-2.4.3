...
void Mp3::CheckLoop()
{
	if (this->ready && this->pimex)
	{
		...
		while (this->pimex->GetEvent(&evCode, &p1, &p2, 0) == S_OK)
		{
			this->pimex->FreeEventParams(evCode, p1, p2);
			...
			if (evCode == EC_COMPLETE)
			{
				...
				if (this->pims)
				{
					this->pims->SetPositions(&pos, AM_SEEKING_AbsolutePositioning | AM_SEEKING_SeekToKeyFrame, NULL, AM_SEEKING_NoPositioning);
				}
