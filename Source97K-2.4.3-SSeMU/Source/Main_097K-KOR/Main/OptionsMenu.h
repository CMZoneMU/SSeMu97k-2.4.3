...
#define MAX_RESOLUTION_VALUE 9

#define Color4b(r, g, b, a) (((a) << 24) | ((r) << 16) | ((g) << 8) | (b))
#define CenterTextPosY(text, y) ((y) - 5)
#define REAL_WIDTH(w) ((w) * WindowWidth / 640)
#define RT3_SORT_CENTER 1
#define CHARACTER_SCENE 1
#define MAIN_SCENE 5
