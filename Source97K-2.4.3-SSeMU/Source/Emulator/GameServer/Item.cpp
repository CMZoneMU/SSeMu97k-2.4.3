...
void CItem::Convert(int index,BYTE Option1,BYTE Option2,BYTE Option3,BYTE NewOption,BYTE SetOption) // OK
{
	...
	if(ItemInfo.RequireLevel != 0)
	{
		...
		else if((this->m_Index >= GET_ITEM(12,7) && this->m_Index <= GET_ITEM(12,24) && this->m_Index != GET_ITEM(12,15))) // Orbs
		{
			this->m_RequireLevel = ItemInfo.RequireLevel;
		}
...
void CItem::Value() // OK
{
	...
	else
	{
		...
		if(((this->m_Index/MAX_ITEM_TYPE) == 12 && (this->m_Index > GET_ITEM(12,6) && this->m_Index < GET_ITEM(12,24))) || (this->m_Index/MAX_ITEM_TYPE) == 13 || (this->m_Index/MAX_ITEM_TYPE) == 15)
		{
