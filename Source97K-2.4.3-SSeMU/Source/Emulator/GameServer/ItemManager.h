...
#define INVENTORY_FULL_RANGE(x) (((x)<0)?0:((x)>=INVENTORY_MAIN_SIZE)?0:1)
...
#define INVENTORY_SHOP_RANGE(x) (((x)<INVENTORY_MAIN_SIZE)?0:((x)>=INVENTORY_SIZE)?0:1)
#define TRADE_RANGE(x) (((x)<0)?0:((x)>=TRADE_SIZE)?0:1)
#define WAREHOUSE_RANGE(x) (((x)<0)?0:((x)>=WAREHOUSE_SIZE)?0:1)
#define WAREHOUSE_MAIN_RANGE(x) (((x)<0)?0:((x)>=WAREHOUSE_SIZE)?0:1)
