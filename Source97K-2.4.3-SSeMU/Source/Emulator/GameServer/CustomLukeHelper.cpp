...
// CustomLukeHelper.cpp: implementation of the CCustomLukeHelper class.
//
//////////////////////////////////////////////////////////////////////
...
CCustomLukeHelper::CCustomLukeHelper()
{
	...
	this->m_CustomLukeHelperSwitch = 0;
...
void CCustomLukeHelper::ReadCustomLukeHelperInfo(char* section,char* path)
{
	this->m_CustomLukeHelperSwitch = GetPrivateProfileInt(section,"CustomLukeHelperSwitch",0,path);
}

void CCustomLukeHelper::Load(char* path)
{
...
CUSTOM_LUKE_HELPER_RESPAWN* CCustomLukeHelper::GetInfo(int index)
{
...
void CCustomLukeHelper::MainProc()
{
	if(this->m_CustomLukeHelperSwitch == 0)
	{
		return;
...
void CCustomLukeHelper::ProcState_BLANK()
{

}

void CCustomLukeHelper::ProcState_EMPTY()
{
...
void CCustomLukeHelper::ProcState_START()
{
	if(this->m_RemainTime <= 0)
	{
...
void CCustomLukeHelper::SetState(int state)
{
	if(this->m_CustomLukeHelperSwitch == 0)
	{
		return;
...
void CCustomLukeHelper::SetState_BLANK()
{

}

void CCustomLukeHelper::SetState_EMPTY()
{
...
void CCustomLukeHelper::SetState_START()
{
	this->SetMonster();
...
void CCustomLukeHelper::CheckSync()
{
...
void CCustomLukeHelper::SetMonster()
{
	if(OBJECT_RANGE(this->m_LukeHelperIndex) != 0)
	{
		return;
...
bool CCustomLukeHelper::NpcLukeHelper(LPOBJ lpNpc,LPOBJ lpObj)
{
