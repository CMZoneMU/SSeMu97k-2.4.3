...
// Convert key index (0~65535) into 128 bits (16 bytes) MD5 key value
...
// Convert key index (0~255) into 32 bytes MD5 string
...
// Check MD5 key value against key index (true: match / false: mismatch)
